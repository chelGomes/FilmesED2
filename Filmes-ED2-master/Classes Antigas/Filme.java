...
import Relatorio.Recibo;
import java.util.ArrayList;
//import java.util.Collections;

/**
 * Classe que contem as funcoes do objeto Filme
 */
public class Filme {
    ...
    public Filme(String nome, String partido, String estado, int id) {
        this.nome = nome;
        this.totalGasto = 0;
    ...
    /**
     * Essa funcao imprime os dados basicos do Filme
     */
