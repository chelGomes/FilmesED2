...
public class ArvoreVermelhoPreto {
     ...
     */
    public NoVermelhoPreto busca(int id, RelatorioArvore relatorio) {
     ...
     * @return NoVermelhoPreto
     */
    private NoVermelhoPreto procurar(NoVermelhoPreto procurar, NoVermelhoPreto No, RelatorioArvore relatorio) {
        if (raiz == nulo) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise  
     */
    private void balancear(NoVermelhoPreto No, RelatorioArvore relatorio) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise  
     */
    private void rotacionarEsquerda(NoVermelhoPreto No, RelatorioArvore relatorio) {
        relatorio.incrementaTrocaColisaoCopia();
        if (No.getPai() != nulo) {
            relatorio.incrementaInteracao();
            if (No == No.getPai().getEsq()) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise  
     */
    private void rotacionarDireita(NoVermelhoPreto No, RelatorioArvore relatorio) {
        relatorio.incrementaTrocaColisaoCopia();
        if (No.getPai() != nulo) {
            relatorio.incrementaInteracao();
            if (No == No.getPai().getEsq()) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise  
     */
    private void transplantar(NoVermelhoPreto alvo, NoVermelhoPreto no, RelatorioArvore relatorio) {
        if (alvo.getPai() == nulo) {
            relatorio.incrementaInteracao();
            raiz = no;
            relatorio.incrementaTrocaColisaoCopia();
     ...
     * @return 
     */
    public boolean remover(int id, RelatorioArvore relatorio) {
     ...
     * @return 
     */
   private boolean remover(NoVermelhoPreto no, RelatorioArvore relatorio) {
    ...
    * @param relatorio Acesso ao relatorio para gravar os dados de analise  
    */
    private void arrumarNoRemovido(NoVermelhoPreto no, RelatorioArvore relatorio) {
     ...
     * @return subArvore
     */
    private NoVermelhoPreto arvoreMinima(NoVermelhoPreto subArvore, RelatorioArvore relatorio) {
