...
import Relatorio.RelatorioArvore;
...
public class ArvoreB {
     ...
     */
    public ArvoreB(int ordem, RelatorioArvore relatorio) {
        this.raiz = new NoB(ordem);
        this.ordem = ordem;
        nElementos = 0;
    }

    public int getnElementos(RelatorioArvore relatorio) {
        return nElementos;
    }

    public void setOrdem(int ordem, RelatorioArvore relatorio) {
        this.ordem = ordem;
    }

    public int getOrdem(RelatorioArvore relatorio) {
        return ordem;
    }

    public NoB getRaiz(RelatorioArvore relatorio) {
        return raiz;
    }
    /**
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    public void inserir(int id, Chave chave, RelatorioArvore relatorio) {
        chave.setId(id);
    ...
    private void divideNo(NoB noPai, int i, NoB noFilho, RelatorioArvore relatorio) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void insereNoNaoCheio(NoB noInserir, Chave chave, RelatorioArvore relatorio) {
     ...
     */
    public NoB busca(int id, RelatorioArvore relatorio) {
     ...
     */
    private NoB buscaChave(NoB no, Chave chave, RelatorioArvore relatorio) {
        int i = 1;
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    public void remover(int id, RelatorioArvore relatorio) {
        Chave chave = new Chave();
        chave.setId(id);
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void remover(Chave chave, RelatorioArvore relatorio) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void balanceiaFolha(NoB noFolha, RelatorioArvore relatorio) {
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void diminuiAltura(NoB no, RelatorioArvore relatorio) {
        int j;
        NoB aux = new NoB(ordem);
        if (no == this.raiz) {
            relatorio.incrementaInteracao();
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void balanceiaEsqDir(NoB noPai, int e, NoB Esq, NoB Dir, RelatorioArvore relatorio) {
        try{
        relatorio.incrementaTrocaColisaoCopia();
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void balanceiaDirEsq(NoB noPai, int e, NoB Dir, NoB Esq, RelatorioArvore relatorio) {
        relatorio.incrementaTrocaColisaoCopia();
        Esq.setOrdem(Esq.getOrdem() + 1);
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    private void juncaoNo(NoB noPai, int i, RelatorioArvore relatorio) {
     ...
     */
    private NoB antecessor(NoB no, Chave chave, RelatorioArvore relatorio) {
        int i = 1;
     ...
     * @return 
     */
    private NoB getPai(NoB noIni, NoB no, RelatorioArvore relatorio) {
        if (this.raiz == no) {
            relatorio.incrementaInteracao();
            return null;
        }
     ...
     * @param relatorio Acesso ao relatorio para gravar os dados de analise 
     */
    public void deletarArvore(NoB no, int ordem, RelatorioArvore relatorio) {
        this.raiz = new NoB(ordem);
        this.ordem = ordem;
        nElementos = 0;
    }
